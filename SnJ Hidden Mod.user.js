...
// @updateURL    https://raw.githubusercontent.com/migm-user/save/main/SnJ%20Hidden%20Mod.user.js
// @downloadURL  https://raw.githubusercontent.com/migm-user/save/main/SnJ%20Hidden%20Mod.user.js
// ==/UserScript==
    ...
    function clickNotificationBell() {
        ...
        if (!bell) {
            if (!bellWarningShown && settings.autoBuy) {
                ...
                alert(`이 메세지는 SnJ Hidden Mod 사용자에게 전송 되는 것입니다.
...
으로 설정한 후 다시 시도하세요.`);
    ...
    function createUI() {
        ...
        panel.hidden = true;
        panel.innerHTML = `
            <div class="snail-head"><div class="snail-title">🐌 SnJ Hidden Mod</div><button class="snail-close" aria-label="닫기">×</button></div>
